    ...
    <div>
        <div class="mb-4 flex flex-col sm:flex-row justify-between items-center">
            ...
            <div class="flex gap-4">
                <a href=""
                    class="inline-flex items-center px-4 py-2 text-white bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg shadow-md hover:from-blue-600 hover:to-indigo-700 transition duration-300 ease-in-out"
                    target="_blank">
                ...
                <form method="GET" action="{{ 'BPB.sub_bpb' }}">
                    <div class="relative">
...
<div id="subBpbModal" class="hidden fixed inset-0 bg-gray-800 bg-opacity-95 z-50 overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-gray-900 rounded-lg shadow-lg p-6 w-full max-w-4xl">
            <div class="flex justify-between items-center mb-6">
                ...
                <button onclick="closeModal('subBpbModal')" class="text-gray-400 hover:text-white">
            ...
            <form action="{{ route('BPB.sub_bpb.store', $bpb->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('POST')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="hidden" name="bpb_id" id="bpb_id" />
                        <input type="hidden" name="sub_lpb_id" id="sub_lpb_id" />
                    ...
                    <div>
                        <label for="nama_satuan" class="block text-sm font-medium text-gray-400 mb-1">Satuan</label>
                        <input id="nama_satuan" type="text" name="nama_satuan" value="" readonly
                    ...
                    <div>
                        ...
                        <input id="kuantitas" type="number" name="kuantitas" value="" readonly
                            class="block w-full px-3 py-2 rounded-md bg-gray-700 border border-gray-600 text-white" />
                    </div>
                ...
                <div class="flex justify-end mt-6 space-x-3">
                    <button type="button" onclick="closeModal('subBpbModal')"
