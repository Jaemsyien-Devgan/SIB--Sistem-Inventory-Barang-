...
<div class="container mx-auto ">
    ...
    <div class="w-full mx-auto bg-gray-800 text-white rounded-lg overflow-hidden shadow-lg">
        ...
        <div class="divide-y divide-gray-700">
            ...
            <div class="px-6 py-4 flex items-center">
                <span class="w-8 h-8 rounded-full bg-green-500 flex items-center justify-center mr-4">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            {{-- <div class="px-6 py-4 flex items-center">
                ...
                <div>
                    <p class="text-sm text-gray-400">Kelompok Anggaran</p>
                    <p class="font-semibold">{{ $administrasi->anggaran->nama_anggaran }}</p>
                </div>
            </div> --}}
        </div>
    </div>
