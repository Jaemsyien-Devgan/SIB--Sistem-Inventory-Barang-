...
@section('content')
            ...
            <div class="bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg border border-gray-700 border-1 p-4">
                ...
                <form action="{{ route('item.store') }}" method="POST">
                    ...
                    <div class="p-6 text-gray-100 grid gap-6">
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                <label for="kode_item" class="block text-sm font-medium">Kode Item</label>
                                <div class="relative">
                                    <input id="kode_item"
                                        class="block mt-1 w-full pl-10 bg-gray-700 border-gray-600 rounded-md"
                                        type="text" name="kode_item" value="{{ $nextKodeItem }}" readonly
                                        autofocus />
                            ...
                            <div>
                                <label for="nama_item" class="block text-sm font-medium">Nama Item</label>
                                <div class="relative">
                                    <input id="nama_item"
                                        class="block mt-1 w-full pl-10 bg-gray-700 border-gray-600 rounded-md"
                                        type="text" name="nama_item" value="{{ old('nama_item') }}" required />
                                    <div class="absolute inset-y-0 left-0 flex items-center pl-3">
    ...
    <div class="p-6 bg-gray-100 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <div>
            <div class="mb-4 flex flex-col sm:flex-row justify-between items-center">
                ...
                <form id="searchForm" method="GET" action="{{ route('item.index') }}">
                    <div class="relative">
    ...
    @foreach ($items as $item)
        <div id="modal_item_{{ $item->id }}" class="fixed z-10 inset-0 overflow-y-auto hidden"
                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <div
                            ...
                            <!-- Edit Form -->
                            <form id="editForm" method="POST" action="{{ route('item.update', $item->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="p-6 text-gray-100 grid gap-6">
                                    <div class="grid grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <div class="relative">
                                                <input id="kode_item"
                                                    class="block mt-1 w-full pl-10 bg-gray-700 border-gray-600 rounded-md"
                                                    type="text" name="kode_item" value="{{ $item->kode_item }}"
                                                    readonly autofocus />
                                                <div class="absolute inset-y-0 left-0 flex items-center pl-3">
                                                    <i class="fa-solid fa-clipboard-list h-5 w-5 text-yellow-400"></i>
                                                </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="relative">
                                                <input id="nama_item"
                                                    class="block mt-1 w-full pl-10 bg-gray-700 border-gray-600 rounded-md"
                                                    type="text" name="nama_item" value="{{ $item->nama_item }}"
                                                    required />
                                                <div class="absolute inset-y-0 left-0 flex items-center pl-3">
                                                    <i class="fa-solid fa-file-signature h-5 w-5 text-red-400"></i>
                                                </div>
    ...
    <script>
        function openModal(id) {
            ...
            document.getElementById(`modal_item_${id}`).classList.remove('hidden');
        }

        function closeModal(id) {
            // Menambahkan class 'hidden' untuk modal dengan ID yang sesuai
            document.getElementById(`modal_item_${id}`).classList.add('hidden');
        }
