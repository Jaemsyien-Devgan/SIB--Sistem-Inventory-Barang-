...
@section('content')
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    <input id="start_date"
                                        ...
                                        type="date" name="start_date" value="{{ date('Y-m-d') }}" required />
                                    <div class="absolute inset-y-0 left-0 flex items-center pl-3">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <div class="absolute inset-y-0 left-0 flex items-center pl-3">
                                        <i class="fa-solid fa-scale-balanced h-5 w-5 text-blue-400"></i>
                                    </div>
        ...
        <div>
            <div class="mb-4 flex flex-col sm:flex-row justify-between items-center">
                <div class="flex flex-row mb-2 sm:mb-0">
                    ...
                    <form action="{{ route('proyek') }}" method="GET" id="status-form">
                        @csrf
                        <div class="relative">
            ...
            <div class="overflow-x-auto bg-white dark:bg-gray-800 rounded-lg shadow overflow-y-auto">
                ...
                @if ($proyeks instanceof \Illuminate\Pagination\LengthAwarePaginator)
                    <div class="m-6">
    ...
    @foreach ($proyeks as $proyek)
        <div id="modal_proyek_{{ $proyek->id }}" class="fixed z-10 inset-0 overflow-y-auto hidden"
                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <div
                            ...
                            <!-- Edit Form -->
                            <form id="editForm" method="POST" action="{{ route('proyek.update', $proyek->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="p-6 text-gray-100 grid gap-6">
                                    <div class="grid grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <div class="relative">
                                                <input id="nama_proyek"
                                                    class="block mt-1 w-full pl-10 bg-gray-700 border-gray-600 rounded-md"
                                                    type="text" name="nama_proyek" value="{{ $proyek->nama_proyek }}"
                                                    required />
                                                <div class="absolute inset-y-0 left-0 flex items-center pl-3">
                                                    <i class="fa-solid fa-file-signature h-5 w-5 text-red-400"></i>
                                                </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <div class="relative">
                                                <input id="start_date"
                                                    class="block mt-1 w-full pl-10 bg-gray-700 border-gray-600 rounded-md"
                                                    type="text" name="start_date" value="{{ $proyek->start_date }}"
                                                    required />
                                                <div class="absolute inset-y-0 left-0 flex items-center pl-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="relative">
                                                <select id="status" name="status"
                                                    ...
                                                    required>
                                                    <option value="aktif"
                                                        {{ $proyek->status == 'aktif' ? 'selected' : '' }}>Aktif</option>
                                                    <option value="tidak_aktif"
                                                        {{ $proyek->status == 'tidak_aktif' ? 'selected' : '' }}>Tidak
                                                        Aktif</option>
                                                </select>
                                                <div class="absolute inset-y-0 left-0 flex items-center pl-3">
    ...
    <script>
        function openModal(id) {
            ...
            document.getElementById(`modal_proyek_${id}`).classList.remove('hidden');
        }

        function closeModal(id) {
            // Menambahkan class 'hidden' untuk modal dengan ID yang sesuai
            document.getElementById(`modal_proyek_${id}`).classList.add('hidden');
        }
