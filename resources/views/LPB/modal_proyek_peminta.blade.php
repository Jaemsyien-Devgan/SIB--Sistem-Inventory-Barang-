<div id="modal_proyek_peminta" class="fixed z-10 inset-0 overflow-y-auto hidden" aria-labelledby="modal-title"
                        ...
                        <div class="p-6">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-4 py-2 whitespace-nowrap text-sm font-medium">
                                                        <button
                                                            ...
                                                            onclick="selectAdministrasi('{{ $item->id }}','{{ $item->kode_proyek }}', '{{ $item->nama_proyek }}')">
                            ...
                            <div class="mt-6 flex justify-end space-x-3">
                                <button class="bg-gray-600 hover:bg-gray-500 text-white font-bold py-2 px-4 rounded"
                                    onclick="closeModal('modal_proyek_peminta')">Close</button>
                            </div>
                        </div>
                    </div>
                </div>
