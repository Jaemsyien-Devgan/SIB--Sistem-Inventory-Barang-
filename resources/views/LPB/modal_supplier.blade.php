<div id="modal_supplier" class="fixed z-10 inset-0 overflow-y-auto hidden" aria-labelledby="modal-title"
                ...
                <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <div
                        ...
                        <div class="p-6">
                            <h2 class="text-lg font-medium text-gray-100">Supplier</h2>
                            <p class="mt-1 text-sm text-gray-400">Pilih Supplier...</p>
                            <div class="mt-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-4 py-2 whitespace-nowrap text-sm font-medium">
                                                        <button
                                                            ...
                                                            onclick="selectSupplier('{{$item->id}}','{{ $item->kode_supplier }}', '{{ $item->nama_supplier }}')">
                            ...
                            <div class="mt-6 flex justify-end space-x-3">
                                <button class="bg-gray-600 hover:bg-gray-500 text-white font-bold py-2 px-4 rounded"
                                    onclick="closeModal('modal_supplier')">Close</button>
                            </div>
                        </div>
                    </div>
                </div>
